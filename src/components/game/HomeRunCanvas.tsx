...
const OBSTACLE_GAP_BASE_START = 320
const OBSTACLE_GAP_BASE_END = 168
const OBSTACLE_GAP_JITTER_START = 230
const OBSTACLE_GAP_JITTER_END = 92
const OBSTACLE_FIRST_OFFSET_START = 140
const OBSTACLE_FIRST_OFFSET_END = 70
